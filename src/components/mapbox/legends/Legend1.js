...
import RAISGPressoes2018_Petroleo_geral1 from './components/RAISGPressoes2018_Petroleo_geral1.js'
...
class LegendCollapse extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            {legend == 'legend2' &&
                <div>
                    <RAISGPressoes2018_Petroleo_geral1 key="legend11" defaultOpened={false} _onChangeHandler={this._onChangeHandler.bind(this)} />
                </div>
            }
            </div>
        );
