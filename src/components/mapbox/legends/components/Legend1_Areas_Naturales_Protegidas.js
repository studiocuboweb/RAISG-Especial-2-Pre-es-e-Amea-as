...
class Legend1_Areas_Naturales_Protegidas extends Component {
    ...
    render () {
        ...
        return (
            <div>
                {(legendGroup == 'legend_group7' || legendGroup == 'legend_group8') &&
                ...
                {(legendGroup != 'legend_group7' && legendGroup != 'legend_group8')  &&
                    <input type="checkbox" name='areas-protegidas' defaultChecked={true} onChange={this._onChangeHandler.bind(this,'areas-naturales-protegidas')} />
                }
