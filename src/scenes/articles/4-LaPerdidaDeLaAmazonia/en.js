...
export default () => (
  <article>
    <Helmet>
    <title>The loss of Amazonia | Amazonia at the crossroads</title>
    </Helmet>
    <Container>
      <Title as="h2">The loss of Amazonia</Title>
      <Note>
        <p>
      ...
      <Paragraph>
        In Bolivian Amazonia, as has been happening for more than a decade, there is a development model based on land use conversion. That is, 
        <StoryMedia
          media={{
            id: "image-2",
            type: "image",
      ...
      <Paragraph>
        The overview of Colombian Amazonia reveals high deforestation, an increase in illicit crops and the presence of forest fires. In addition, in the National Development Plan, the current government has decided that there will be no change in its deforestation goal relative to the previous government's four-year administration. That is to say, the destruction of 215,000 hectares of forest per year will be allowed at the national level, <ExternalLink href="https://www.elespectador.com/noticias/medio-ambiente/las-cifras-de-deforestacion-para-la-amazonia-colombiana-que-no-convencen-articulo-839968" language="es">of which 72% will be from Amazonia region</ExternalLink>. There is thus a green light for economic development projects previously not allowed in this region of Colombia.
      </Paragraph>
      ...
      <Paragraph>
        ...
        <StoryMedia
          ...
          > the Waorani have filed a constitutional complaint to halt a government plan to explore oil in Amazonia
        </StoryMedia>, 
      ...
      <Paragraph>
        In respect of the frequent oil spills that have occurred in Peruvian Amazonia in recent years, which have a direct impact on the water sources and food security of the local population, which mostly comprises indigenous communities, they are demanding that the State honour its commitment to provide environmental remediation, potable water services and specialized medical care.
      </Paragraph>
