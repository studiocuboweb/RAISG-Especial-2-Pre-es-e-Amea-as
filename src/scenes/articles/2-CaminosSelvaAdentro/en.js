...
export default () => (
  <article>
    <Helmet>
      <title>Routes into the forest | Amazonia at crossroads</title>
    </Helmet>
    <Container>
      ...
      <Note>
        <p>
          ...
          railways and waterways in the Amazon forest has always been and always will be the main vector of transformation of the territory.
        </p>
      </Note>

      <Paragraph>
        By 2018 more than 136,000 kilometres of roads had been built in the Pan-Amazon region, of which 26,000 kilometres are located within protected natural areas and indigenous territories. Of this total, 16,900 kilometres cross indigenous territories and 9,100 kilometres cross protected natural areas.
      </Paragraph>
      ...
      <Paragraph>
        Currently, the Colombian Amazon has a total of 32,780 km of level 1 to 7 roads, with levels 6 and 7 (tertiary roads) representing the largest amount by distance, with a total of 
        <StoryMedia
        icon="map"
        media={{
        id: "map_03",
      ...
      <FeaturedText>
        In Colombia, after the signing of the peace agreement, FARC guerrillas stopped occupying strategic entry points in the Amazon jungle. At these points, the presence of the state is almost non-existent, so new actors (legal and illegal) have begun to arrive in search of natural resources and lands.
      </FeaturedText>

      <Paragraph>
        This has been facilitated by the rapid opening of new routes and the formalization of others built by FARC guerrillas before the signing of the peace agreement. They are mainly tertiary roads, the new way to penetrate the heart of the jungle. As shown in the map of pressures and threats (RAISG, 2018), the presence of roads in Colombia is concentrated in the northwest arc of the Amazon. In the case of FARC roads, of <ExternalLink href="https://www.elespectador.com/noticias/judicial/las-farc-habrian-construido-mas-vias-que-odebrecht-y-los-nule-juntos-articulo-709623" language="es">3,753 kilometres built</ExternalLink>, <ExternalLink href="https://www.youtube.com/watch?v=j4IuJHhdCjk" language="es">490 km are inside protected areas</ExternalLink> of the Colombian Amazon, specifically in the Serras de Chiribiquete National Park, the Nukak National Wildlife Reserve and the Tinigua Natural National Park.
      </Paragraph>
      ...
      <Paragraph>
        Two important access routes to the Amazon territory in Peru also act as vectors of deforestation:
        <StoryMedia
        icon="map"
        media={{
        id: "map_06",
      ...
      <Paragraph>
        The works include the dredging or removal of sediments in shallow and rocky stretches of these rivers. Experts warn of the environmental impact, since environmental protection regulations for the transport sector do not include specific measures for waterways. In addition, they point out that the project has not considered the impact of river dredging on the migration, reproduction and spawning of fish, nor has it taken into account the turbidity that will affect the water used by local populations. All this points to an expectation that the waterway will become a new focus of socio-environmental conflict. However, there is reason for hope, since in a decision of March 2019, the National Environmental Certification Service for Sustainable Investment (Senace) rejected the Environmental Impact Assessment (EIA) of the Amazon Waterway project for the second time. Without this, work cannot start.
      </Paragraph>
      ...
      <Paragraph>
        On the other hand, a main thrust of the continuous expansion of transport infrastructure in the Brazilian Amazon is railway construction. The Ferrogrão line, almost a thousand kilometres long, from the
        <StoryMedia
          icon="map"
          media={{
          id: "map_08",
