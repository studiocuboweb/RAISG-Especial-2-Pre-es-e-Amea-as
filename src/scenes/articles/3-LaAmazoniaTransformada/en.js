...
export default () => (
  <article>
    <Helmet>
      <title>Amazonia transformed | Amazonia at the crossroads</title>
    </Helmet>
    <Container>
      <Title as="h2">Amazonia transformed</Title>
      <Note>
        <p>
      ...
      <Paragraph>
        ...
        <StoryMedia
          ...
          But the existence of such an area confirms the proposed model for the countries of the region: one based on extraction and profit, with no evaluation of the consequences of losing more than a quarter of Amazonia.
      </Paragraph>
      ...
      <Paragraph>
        ...
        > According to the energy and mining investment watchdog, Osinergmin, 190 oil spills were recorded in Peruvian Amazonia over 20 years
        </StoryMedia>.
      ...
      <Paragraph>
        Oil spills in Peruvian Amazonia have caused serious environmental impacts - pollution of water courses and fish mortality, as well as serious cultural and social damage to the indigenous population, since the leaks affect their health and quality of life and have not been adequately addressed to date.
      </Paragraph>
        ...
        <StoryMedia
          ...
          type: "mapbox",
            data: {
              ...
              update:"map10",
              showExtraLayers: [],
              coordinates: [-64.284679,5.341481],
              zoomNumber: 5.85,
              zoomMin: 4,
              zoomMax: 22
            }
      ...
      <Paragraph>
        ...
        > of the seven national parks in Venezuelan Amazonia, six have areas of illegal mining within their borders
        </StoryMedia>.
